...
/*!\mainpage
*
* Liberty is a widely used library format introduced by Synopsys.  This software parses all information from a Liberty file and makes it available through a convenient API.  This parser finds use in timing analysis tools, library analyzers, and library sanity checkers.
*/
